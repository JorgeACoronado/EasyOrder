...
<template>
  <main class="min-h-screen bg-stone-200 px-4 py-6">
    <div class="mx-auto w-full max-w-[400px]">
      <header class="mb-6">
        ...
        <div class="mt-4 flex flex-wrap gap-2">
          <button
            class="rounded-full bg-pink-100 px-3 py-1 text-sm text-stone-700"
    ...
    <button
      class="fixed right-6 bottom-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-pink-400 text-2xl text-white shadow-lg"
      @click="goToCart"
    >
      🛒
